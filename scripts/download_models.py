...
def main():
    ...
    if args.voice:
        ...
        os.environ["HF_HOME"] = str(config.directory / "voice/model/huggingface")
        ...
        if not model.has_voice_cloning:
            raise RuntimeError("Downloaded weights do not allow reference voices. Obtain authorized voice-cloning weights before enabling personal speech.")
